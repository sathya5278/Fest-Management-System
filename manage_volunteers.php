...
<body>
    ...
    <div class="search-bar-wrapper">
        <div class="search-bar">
                ...
                <div>
                    <span>
                        <input name="search" size="30" type="text" placeholder="Search Volunteers..." />
                    </span>
 ...
 <section>
                    ...
                    <tr>
                      ...
                      <td class="dropdown1">
                          ...
                          <div id="dropdown1<?php echo $i ?>" class="dropdown-content1">
                            ...
                            <a href="modify_volunteers.php?v_usn=<?php echo $row["V_USN"] ?>">Edit</a>
                            <a href="delete_volunteers.php?v_usn=<?php echo $row["V_USN"] ?>"
            ...
            if ($back_button) { ?>
                    <div >
                        <button onclick="window.location.href='manage_volunteers.php';" id="search">Go Back</button>
                    </div>
            <?php }
            $conn->close(); ?>
    <script>
