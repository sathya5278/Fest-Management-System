...
<body>
    ...
    <div class="search-bar-wrapper">
        <div class="search-bar">
                ...
                <div>
                    <span>
                        <input name="search" size="30" type="text" placeholder="Search Participants..." />
                    </span>
 ...
 <section>
                    ...
                    <tr>
                      ...
                      <td class="dropdown1">
                          ...
                          <div id="dropdown1<?php echo $i ?>" class="dropdown-content1">
                            ...
                            <a href="modify_participant.php?p_usn=<?php echo $row["P_USN"] ?>">Edit</a>
                            <a href="delete_participant.php?p_usn=<?php echo $row["P_USN"] ?>"
            ...
            if ($back_button) { ?>
                    <div >
                        <button onclick="window.location.href='manage_participants.php';" id="search">Go Back</button>
                    </div>
            <?php }
            $conn->close(); ?>
    <script>
