...
<body>
    ...
    <div class="search-bar-wrapper">
        <div class="search-bar">
                ...
                <div>
                    <span>
                        <input name="search" size="30" type="text" placeholder="Search Logistics..." />
                    </span>
                    ...
                    <span>
                        <select name="by">
                            <option value="id">LOGISTICS ID</option>
 ...
 <section>
                    ...
                    <tr>
                      ...
                      <td class="dropdown1">
                          ...
                          <div id="dropdown1<?php echo $i ?>" class="dropdown-content1">
                            ...
                            <a href="modify_logistics.php?l_id=<?php echo $row["L_ID"] ?>">Edit</a>
                            <a href="delete_logistics.php?l_id=<?php echo $row["L_ID"] ?>"
            ...
            if ($back_button) { ?>
                    <div >
                        <button onclick="window.location.href='manage_logistics.php';" id="search">Go Back</button>
                    </div>
            <?php }
            $conn->close(); ?>
    <script>
